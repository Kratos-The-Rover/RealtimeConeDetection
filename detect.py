...
def detect(
    ...
    if webcam:
        save_images = False
        dataloader = LoadWebcam(img_size=img_size, webcam=webcam_index)
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--cfg", type=str, default="cfg/yolov3.cfg", help="cfg file path"
    )
    parser.add_argument(
        "--weights", type=str, default="weights/best.pt", help="path to weights file"
    )
    parser.add_argument(
        "--images", type=str, default="data/samples", help="path to images"
    )
    parser.add_argument(
        "--img-size", type=int, default=32 * 13, help="size of each image dimension"
    )
    parser.add_argument(
        "--conf-thres", type=float, default=0.50, help="object confidence threshold"
    )
    parser.add_argument(
        "--nms-thres",
        type=float,
